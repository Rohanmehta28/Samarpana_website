      ...
      <footer className="relative bg-req-blue">
        <div className="flex text-white md:p-4 md:text-xl justify-between py-8 px-8">
          ...
          <div className='flex text-white sm:px-8 md:px-12 text-[25px]'>
            <a className='px-1' target = "_blank" href = "https://www.instagram.com/samarpana.india/"><FaInstagram/></a>
            <a className='px-1' target = "_blank" href = "https://mail.google.com/mail/?view=cm&fs=1&to=samarpana@pes.edu"><SiGmail/></a>
          </div>
        </div>
      </footer>
    </div>
