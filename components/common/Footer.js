...
function Footer() {
  return (
    <div className="block relative pt-20 md:pt-0">
      ...
      />
      <footer className="absolute md:-bottom-0 w-full inset-x-0 bg-opacity-100 bg-black py-20 md:py-2">
        <div className="flex flex-col gap-8 md:flex-row font-red-hat justify-center items-center md:items-start text-center md:text-left md:justify-between px-8">
