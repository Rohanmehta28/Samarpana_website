    ...
    <div className="p-4 border-2 border-slate-500 rounded-lg">
      ...
      <div className="text-step--1 my-4">
        <h4 className="font-bold text-step-1 p-2 border-2 border-green-600 rounded-lg text-green-600 my-4">
          ...
          It’s not the amount that matters but the meaning behind the donation.
          The efforts of one person can’t move mountains. We would be humbled
          for any amount of funds donated towards this great cause
        </h4>
        <ul>
