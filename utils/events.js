export const events = {
  ...
  'workshops-and-legal-aids': {
    ...
    next: '/events/ev/workshops-and-legal-aids',
    eventdescription:
      "Entrepreneurship Workshops and Women Empowerment workshops are conducted every year for the benefit of the martyrs' families. Families undergo check-ups and medicines are prescribed and distributed, free of cost.",
  },
  bakesale: {
    ...
    eventDescp2: 'Bakesale info needed ****************',
    image: '/assets/e1.jpg',
    next: '/events/ev/bakesale',
    eventdescription:
  ...
  'army-vs-pesu-sports': {
    ...
    next: '/events/ev/army-vs-pesu-sports',
    eventdescription:
      'In the spirit of sportsmanship, Samarpana brings to you, ARMY v/s PESU sports, where students of PES will be playing at odds with our Army jawans',
  },
  'cultural-evenings': {
    ...
    next: '/events/ev/cultural-evenings',
    eventdescription:
  ...
  'samarpana-talks': {
    ...
    next: '/events/ev/samarpana-talks',
    eventdescription:
      'A session where eminent guest speakers from the army share their experiences with the students and the army community. Here the guest speakers discuss the various facets of life in various fields.',
  },
}
